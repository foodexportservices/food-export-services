...
const Login = () => {
  ...
  return (
    <>
      <Box display={{ md: "flex", base: "none" }} w="100vw" h="100vh">
        <HStack w="100%" h="100%">
      ...
      <Box display={{ md: "none", base: "flex" }} w="100dvw" h="100dvh">
        <VStack alignItems="center" px="2rem" pt="10rem" w="100%" h="100%">
          <VStack
            w="100%"
            borderRadius="20px"
            // p="20px 60px"
          ...
          >
            ...
            <Text fontSize="1.4rem" fontWeight="600" mb="1rem">
              Welcome Back !
            </Text>
